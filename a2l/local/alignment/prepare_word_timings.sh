...
local/alignment/islands_to_status.py $working_dir/ref_and_hyp_match $working_dir/hyp_and_ref_match \
...
local/alignment/segment_to_actual_word_time.py $main_working_dir/WORD_TIMINGS.tmp \
